      ...
      {mode === 'text' && (
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <h5 className="font-medium text-gray-800 text-sm mb-2">Text to Place</h5>
            <Input
              value={currentText}
          ...
          {/* Font Size */}
          <div className="space-y-2">
            <h5 className="font-medium text-gray-800 text-sm mb-2">Size: {textSettings.fontSize}px</h5>
            <Slider
          ...
          <div className="space-y-3">
            <h5 className="font-medium text-gray-800 text-sm mb-2">Font & Style</h5>
