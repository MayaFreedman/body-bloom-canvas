  ...
  return (
    ...
    >
      ...
      <Input
        ...
        className="flex-1 border border-foreground/20 rounded-lg px-4 py-2 text-base hover:border-foreground/40 focus:border-foreground focus:outline-none focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
      />
    </div>
  );
};
